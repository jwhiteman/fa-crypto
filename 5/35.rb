...
# 1. if g is 1,   S is 1
# 2. if g is p,   S is 0
# 3. if g is p-1, S is 1

{ 1 => 1, p => 0, (p - 1) => 1 }.each do |mitm_g, mitm_key|
  # mitm intercepts g during parameter negotiation:
  g = mitm_g
  ...
  mallory_s = _to_key(mitm_key)
  msg = _decrypt(c1, mallory_s, iv1)
  puts "mitm successfully decrypts message: #{msg}"
